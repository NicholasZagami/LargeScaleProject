-- ============================================
-- Init DWH (schema) inside the Prefect database
-- public schema is reserved for Prefect.
-- ============================================
...
-- ============================================
-- 2) Drop tables if they exist (clean rebuild)
-- (All tables live in schema dwh)
-- ============================================
